...
<form id="phoneRegistrationForm" method="POST">
    <div>
        ...
        <button class="btn btn-primary" disabled id="getCodeBtnPhone" data-bs-target="#exampleModalToggle" data-bs-toggle="modal" style="height: 40px; border-radius: unset; align-self: center; margin-bottom: 3px; background-color: #ff7b4f; border: unset;">取得驗證碼</button>
        </span>
        </span>
          ...
          <button class="btn btn-primary phoneReg" id="registerPhone" type="submit" value="立即註冊" style="height: 40px; border-radius: unset; align-self: center; margin-bottom: 8px; background-color: #ff7b4f; border: unset; width: 130px; margin-left: 20px;">
            免费开户
          </button>
          </span>
    </div>
