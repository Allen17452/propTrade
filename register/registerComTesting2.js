  ...
  document.getElementById("result").innerHTML = `
    <form id="registrationForm" method="POST" style="text-align: left;">
      <div class="emailContainer">
        ...
        <span class="emailSpan1" style="display: -webkit-inline-box;">
          <span class="container1" style="height: 40px; display: inline-flex; align-items: center;">
          &nbsp;&nbsp;
          <input type="email" id="email" name="email" placeholder="Input Email Address" required style="border: unset; background: unset; outline: none;">
          </span>
        ...
        <span class="emailSpan2" style="width: 450px; display: -webkit-inline-box; display: none;">
        ...
        <button class="btn btn-primary" id="emailRegister" type="submit" value="立即注册" style="height: 40px; border-radius: unset; align-self: center; border: unset; width: 130px;">
        Register
        </button>
        </span>
        </div>
