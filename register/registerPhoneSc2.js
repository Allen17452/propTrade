...
document.addEventListener("DOMContentLoaded", function() {
  ...
  optionA.addEventListener("click", function() {
    ...
    footerContainer.classList.add("optionCStyle");
  });

  optionB.addEventListener("click", function() {
    buttonText.innerHTML = "optionB";
    footerContainer.classList.remove("optionCStyle");
          ...
          <div class="select-box">
              <div class="selected-option" for="phone">
                  ...
                  <div style="display: flex; align-items: center;" class="selectBoxContainer">
                      ...
                      <strong class="countryCode">+86</strong>
                  </div>
                  <span class="iconify" data-icon="pepicons-pencil:line-y" style="color: #000;"></span>
...
var appCodeBF = currentUrl.includes("utm_source=8");
var countries;
if (appCodeBF) {
  countries = [
